...
def main(args):
    ...
    output_dir = f"../depot_hyun/hyun/NDP/sensitivity2/{args.task}/J{int(args.num_training/1_000)}K_{args.layer_len}_{args.layer_num}"
    ...
    if bounds is None:
        net = FL_Net_sen2(D_in = D_in, D_out = D_out, H = Hs, p = 0.1, num = args.layer_num)
    else:
...
"""
    ...
    output_dir = f"../NDP/benchmark/cov_learning/sensitivity2/{args.task}/J_{int(args.num_training/1000)}K/slurm_files"
    os.makedirs(output_dir, exist_ok=True)
