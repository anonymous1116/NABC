...
from module import GRU_CovarianceNet2, GRU_net, GRU_net_bounded
...
def main(args):
    ...
    for epoch in range(N_EPOCHS):
        ...
        if Joint_train:
            ...
            mu_batch = mean_net(x_batch)      # deterministic, grad-enabled
        else:
        ...
        weight_decay_scheduler.step(val_loss)  # or .step() per your API
    ...
    output_dir = f"../depot_hyun/hyun/NDP/{args.task}/mean_{int(args.num_training_mean/1000)}K_cov2_{int(args.num_training_cov/1_000)}K_layer_{args.layer_len}"
