...
from module import GRU_net, GRU_net_bounded, GRU_CovarianceNet
...
def main(args):
    ...
    output_dir = f"./NABC_results/{args.task}_withcov/mean_{int(num_training_mean/1_000)}K_cov_{int(num_training_cov/1_000)}K_{args.layer_len}/{int(args.L/1_000_000)}M_eta{sci_str}"
