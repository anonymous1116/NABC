...
def main(args):
    ...
    X_train, Y_train =  synthetic_fn(args.num_training, args.dim_out)
    ...
    output_dir = f"../depot_hyun/hyun/NDP/{args.task}/mean_{int(args.num_training/1_000)}K/dim_out_{args.dim_out}"
...
echo "Running simulation for task {args.task}, num_training: {args.num_training}, N_EPOCHS: {args.N_EPOCHS} seed={args.seed}, layer_len={args.layer_len}, dim_out={args.dim_out}"
python ./vary_dim_out/training_covs.py \
...
"""
    ...
    output_dir = f"../NDP/benchmark/cov_learning/{args.task}/J_{int(args.num_training/1000)}K/{args.dim_out}/slurm_files"
    os.makedirs(output_dir, exist_ok=True)
