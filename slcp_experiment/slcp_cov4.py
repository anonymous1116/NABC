...
def main(args):
    ...
    output_dir = f"../depot_hyun/hyun/NDP/slcp_experiment/{args.task}/mean_{int(args.num_training_mean/1000)}K_cov4_{int(args.num_training_cov/1_000)}K_layer_{args.layer_len}"
